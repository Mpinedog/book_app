...
# Configure Redis cache for development
config :book_app,
  cache_adapter: :redis,
...
config :book_app, BookAppWeb.Endpoint,
  ...
  code_reloader: true,
  debug_errors: true,
  secret_key_base: "jPuhYlZMMKZbNGiVpu7Nbro7n1jNVthcZRc6z3VLPZHky7kMMkAFyUwJCs/eZ8RR",
  watchers: [
    esbuild: {Esbuild, :install_and_run, [:book_app, ~w(--sourcemap=inline --watch)]},
    tailwind: {Tailwind, :install_and_run, [:book_app, ~w(--watch)]}
  ]
...
config :book_app, BookAppWeb.Endpoint,
  live_reload: [
    ...
    patterns: [
      ...
      ~r"priv/gettext/.*(po)$",
      ~r"lib/book_app_web/(?:controllers|live|components|router)/?.*\.(ex|heex)$"
    ]
  ]
